...
module.exports = {
  ...
  googleGtagPluginConfig: {
    trackingIds: [
      "G-MRBHPT2C54", // Your Google Analytics 4 Measurement ID
    ],
    pluginConfig: {
  ...
  cookieConsentConfig: {
    ...
    language: {
      ...
      translations: {
        en: {
          consentModal: {
            title: "We use one cookie!🍪",
            description: "MicroPasts uses cookies to analyze site traffic and understand how visitors use our website. You can manage your preferences below.",
            acceptAllBtn: "Accept",
